    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (directoryToAddToPath) {
                ...
                var vsTestPath = yield FindVSTest(directoryToAddToPath);
                core.debug(`VSTestPath == ${vsTestPath}`);
                // Add folder where VSTest lives to the PATH
                yield core.addPath(vsTestPath);
                return;
            }
            ...
            var vsTestPath = yield FindVSTest(cachedToolDir);
            core.debug(`VSTestPath == ${vsTestPath}`);
...
function FindVSTest(pathToVSWhere) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        vsTestPath = path.join(vsTestPath, 'Common7\IDE\CommonExtensions\Microsoft\TestWindow\vstest.console.exe');
